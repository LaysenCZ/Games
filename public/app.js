// Počkej na DOM, protože skripty jsou s defer, ale pro jistotu:
document.addEventListener("DOMContentLoaded", () => {
  ...
  function showView(id){
    ...
    if (id === "game") fadeToGameMusic(); else fadeToMenuMusic();
  }

  // Delegace kliků na tlačítka s data-view
  ...
  function initAudio(){
    ...
    if (musicVolume) musicVolume.value = audioMenu.volume;
    if (sfxVolume) sfxVolume.value = sfxClick.volume;
    ...
    // Autoplay: odemkni po prvním kliknutí
    const unlock = () => {
      if (musicEnabled) {
